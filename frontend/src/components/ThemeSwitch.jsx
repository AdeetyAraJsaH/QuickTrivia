...
export default function ThemeSwitch() {
    ...
    const {themeMode,toggleTheme}=useTodo()
    const onChangebtn=(e)=>{
        const themeModeStatus = e.currentTarget.checked
        toggleTheme(themeModeStatus?"dark":"light")
        // if(themeModeStatus)toggleTheme("dark")
        // else toggleTheme("light")
    }
    return (
        <label className="relative inline-flex items-center cursor-pointer" id="theme-toggle-button">
            <input 
            type="checkbox" 
            id="toggle"
            onChange={onChangebtn}
            checked={themeMode==="dark"} />
            <svg height="34" width="56" viewBox="0 0 69.667 44" xmlnsXlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
